...
\usepackage{mathtools}          % automaticamente inclui o pacote amsmath
...
\coorientador{Prof. Dr. Fulano Detal}

\instituicao{Instituto Federal do Espírito Santo --- Campus Serra}
...
\begin{folhadeaprovacao}
  ...
  {\centering Trabalho aprovado. \imprimirlocal, 20 de fevereiro de 2016:}
...
\begin{table}[htb]
  \IBGEtab{
    ...
    \fonte{\LaTeX/Tables - Wikibooks, open books for an open
      world. \url{https://en.wikibooks.org/wiki/LaTeX/Tables}}
  }
\end{table}
...
\begin{figure}[h]
  ...
  \end{tikzpicture}
  \fonte{A Venn Diagram for PDF blending | TikZ
    example. \url{http://www.texample.net/tikz/examples/venn/}}
...
\begin{figure}[h]
  ...
  \end{tikzpicture}
  \fonte{A complete graph | TikZ
    example. \url{http://www.texample.net/tikz/examples/complete-graph/}}
...
\begin{citacao}
  ...
  \hspace*{\fill}--- \citeonline{Levy1999}
\end{citacao}
